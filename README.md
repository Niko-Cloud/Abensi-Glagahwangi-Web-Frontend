Sorry for the commit, i forgot to add the FirebaseService.tsx into the gitignore and commit all of the file, so yeah i just delete the git and commit them all
