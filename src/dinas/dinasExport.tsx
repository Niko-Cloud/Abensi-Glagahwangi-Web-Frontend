...
export const exporter = async (data) => {
    ...
    const worksheet = workbook.addWorksheet('Dinas Permissions');
    ...
    worksheet.columns = [
        ...
        { header: 'Surat Tugas', key: 'file', width: 30 },
    ...
    saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'dinas_permissions.xlsx');
};